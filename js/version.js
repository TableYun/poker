...
export const VERSION_LOG = [
	{
		...
		title: "새 채팅 5초 표시",
		notes: [
			"본인을 포함해 누군가 채팅을 보내면 채팅 로그가 5초 동안 나타났다가 자동으로 접힙니다.",
			"입력칸을 눌러 직접 연 경우에는 자동으로 접히지 않습니다.",
		],
		estimated: false,
	},
	{
	...
	},
	{
		...
		title: "채팅 로그 접기",
		notes: [
			"평소에는 채팅 입력칸만 보이고, 입력칸을 누르면 채팅 로그가 열립니다.",
			"테이블 등 채팅창 바깥을 누르면 로그가 다시 접히고, 모바일 전체 채팅 화면도 바깥을 누르면 닫힙니다.",
		],
		estimated: false,
	},
	{
		version: "1.9.32",
		date: "2026-09-20",
		title: "채팅창 크기 확대·최신 메시지 표시",
		notes: [
			"채팅창 크기를 30% 키워 글이 더 잘 보입니다.",
			"새로고침하거나 다시 접속해도 채팅창이 항상 가장 최근 메시지를 보여줍니다.",
		],
		estimated: false,
	},
	{
		version: "1.9.31",
		date: "2026-09-20",
		title: "채팅창 투명·축소 및 모바일 확대 보기",
		notes: [
			"채팅창 배경이 더 투명해지고 크기가 작아져 테이블을 덜 가립니다.",
			"모바일에서 채팅창을 누르면 채팅 로그와 입력칸이 화면 중앙에 크게 열리고, 닫기 버튼으로 원래 크기로 돌아갑니다.",
		],
		estimated: false,
	},
	{
	...
	},
	{
		...
		title: "채팅창 대폭 확대",
		notes: [
			"채팅창을 훨씬 크게 키웠습니다 (폭 460px·모바일 화면의 92%, 글자 1.15rem, 메시지 영역 최대 320px).",
		],
		estimated: false,
	},
	{
		...
		title: "채팅창 확대",
		notes: [
			"채팅창이 PC와 모바일 모두에서 더 크고 읽기 쉬워졌습니다 (글자·입력칸·전송 버튼 확대).",
		],
		estimated: false,
	},
	{
		...
		title: "테이블 채팅",
		notes: [
			"화면 왼쪽 아래에 채팅창이 생겼습니다. 호스트 화면과 원격 화면 모두에서 플레이어들과 대화할 수 있습니다.",
		],
		estimated: false,
	},
	{
	...
	},
	{
		version: "1.9.19",
		date: "2026-09-19",
		title: "원격 동기화 멈춤 근본 수정",
		notes: [
			"특정 상황에서 호스트의 상태 전송이 조용히 멈춰 원격 화면들이 이전 턴에 얼어붙던 문제를 고쳤습니다. 이제 어떤 계산 오류가 나도 동기화는 계속되고, 문제 좌석의 족보 표시만 잠시 비웁니다.",
		],
		estimated: false,
	},
	{
